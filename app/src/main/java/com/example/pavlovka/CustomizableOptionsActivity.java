...
public class CustomizableOptionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swhWlsLessThenWlsminAndStop = findViewById(R.id.swhWlsLessThenWLsmin);
        swhWlsMoreThenWlsmaxAndStart = findViewById(R.id.swhWlsMoreThenWlsmax);
        swhWlsLessThenWLsmin2AndStart = findViewById(R.id.swhWLSmin2);
        swhWlsMoreThenWlsmax2AndStart = findViewById(R.id.swhtvWLSmax2);
        swhProc1 = findViewById(R.id.swhtvProc1);
        swhMaxTimeStop = findViewById(R.id.swhtvMaxTimeStop);
        swhProc2 = findViewById(R.id.swhtvProc2);
